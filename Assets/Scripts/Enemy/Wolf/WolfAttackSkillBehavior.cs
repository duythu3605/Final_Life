...
public class WolfAttackSkillBehavior : AbstractSkillBehavior
{
    ...
    private void Attack()
    {
        ...
        WolfBulletBehavior buttletClone = Instantiate(_bullet, _firePoint.position, Quaternion.identity).GetComponent<WolfBulletBehavior>();
